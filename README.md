...
## Tools
- Brush, Pen, Pencil, Marker, Highlighter, plus an eraser toggle. Each tool has distinct stroke styling (e.g., jittered pencil, dashed highlighter, shadowed marker). Adjust size/opacity to fine-tune each tool.
